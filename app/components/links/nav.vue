<template>
    <div class="xl:px-[15em] lg:px-[5em] px-[1em] lg:h-[10svh] py-[0.5em] sticky z-50 flex justify-between items-center"
        ...
        <div class="lg:hidden flex items-center">
            <button class="hover:fill-[#004b23] transition-colors duration-300"
                :class="isScrolled ? 'text-[#73a942]' : 'text-[#004b23]'" @click="isMenuOpen = true"
    ...
    <ClientOnly>
        <HelpersDrawer v-if="isMenuOpen" class="bg-[#F0F8FF]" :is-menu-open="isMenuOpen" @close="isMenuOpen = false" />
    </ClientOnly>
</template>
