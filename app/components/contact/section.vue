<template>
    <div class="xl:px-[15em] lg:px-[5em] px-[1em] pb-[4em]">
        <div class="flex md:flex-row flex-col md:gap-[2em] gap-[1em]">
            <div class="md:w-[70%]">
                <div class="bg-[#73a942]/70 md:w-[100%] rounded-[2em] md:p-[4em] p-[2em]">
                    <div class="md:text-[18pt] text-[14pt]">
                        <h2 class="font-bold md:text-[30pt] text-[20pt]">Head Office</h2>
                        <div class="flex flex-col gap-[1em] mt-[0.5em]">
                            <div class="flex gap-[0.5em] items-start flex-wrap">
                                ...
                                <p class="cursor-pointer">Clean Planet Recycle Pvt Ltd, Kunnathunad, <br /> Arackapady,
                                    Ernakulam</p>
                            </div>
                            <div class="flex gap-[0.5em] items-start flex-wrap">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                ...
                <div class="my-[1em]">
                    <h3 class="font-bold md:text-[30pt] text-[20pt]">Other Branches</h3>
                    <div class="flex md:flex-row flex-col md:gap-[1em] gap-[0.5em] my-[0.5em] text-[15pt]">
                        <div class="border-1 border-[#73a942]/70 rounded-[2em] md:p-[2em] p-[1em]">
                            <p class="cursor-pointer">Clean Planet Recycle Pvt Ltd, Aluva East, <br /> Aluva,
                                Ernakulam</p>
                        </div>
                        <div class="border-1 border-[#73a942]/70 rounded-[2em] md:p-[2em] p-[1em]">
                            <p class="cursor-pointer">Clean Planet Eco Solution Pvt Ltd, Kunnathunad, <br /> Kunnathunad
                                (CT),
                                Ernakulam</p>
                        </div>
                    </div>
