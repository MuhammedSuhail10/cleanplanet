<template>
    <div class="xl:px-[15em] lg:px-[5em] px-[1em] pb-[2em]">
        ...
        <p class="lg:text-[18pt] text-[15pt] mt-[1em]">
            We specialize in the entire lifecycle of plastic—from expert segregation
            and baling to the precision manufacturing of fabricated and molded products.
            Based in India, we are dedicated to supplying high-quality, sustainable
