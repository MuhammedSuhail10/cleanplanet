<template>
    <div class="xl:px-[15em] lg:px-[5em] px-[1em] pb-[2em] ">
        <div class="bg-[#004b23]/60 flex flex-col md:flex-row justify-between p-[1em] md:rounded-[3em] rounded-[2em]">
            <div class="text-[#F8F8F8] md:px-[3em] md:py-[2em] py-[1em] flex flex-col justify-between gap-[1em]">
                <div>
